...
export function getTokenInfo(burnedAmount?: string): TokenInfo {
  ...
  return {
    ...
    whitepaper: "https://github.com/FTHTrading/UnyKorn-X402-aws/blob/main/docs/WHITEPAPER.md",
    documentation: "https://github.com/FTHTrading/UnyKorn-X402-aws/blob/main/docs/TOKENOMICS.md",
