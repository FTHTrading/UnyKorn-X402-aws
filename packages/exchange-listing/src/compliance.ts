    ...
    this.checks.push(
      {
        ...
        status: "pass",
        details: "UNYToken.sol inherits OpenZeppelin ERC20 — full standard compliance. Deployed at 0xc090...d66 on Avalanche C-Chain.",
        weight: 10,
      ...
      },
      {
        ...
        status: "pass",
        details: "Source verified on Snowtrace (Avalanche) and Polygonscan. OpenZeppelin base contracts, no proxy patterns.",
        weight: 8,
      ...
      },
      {
        id: "tech-003",
        category: "Technical",
        requirement: "Multi-Chain Deployment",
        description: "Token available on 2+ chains for deposit/withdrawal flexibility",
        status: "pass",
        details: "Deployed on Avalanche C-Chain (43114), UnyKorn L1 (7331), Polygon (137). USDF counterpart on 5 chains (XRPL, Stellar, ETH, SOL, TRON).",
        weight: 7,
      ...
      },
      {
        ...
        status: "partial",
        details: "GitHub security policy active. Formal Immunefi/HackerOne bounty program to be launched — enhances trust score significantly.",
        weight: 6,
      ...
      },
      {
        ...
        status: "partial",
        details: "Deployer key secured. Multi-sig governance setup planned for treasury. Required for Tier 1 exchanges.",
        weight: 7,
        requiredBy: ["Binance", "Coinbase", "Kraken"],
      },
      {
      ...
      },
      {
        ...
        status: "pass",
        details: "Team allocation (10%) has 12-month cliff, 36-month linear vest. Enforced via Staking Vault contract on Polygon.",
        weight: 8,
        requiredBy: ["Binance", "Coinbase", "Kraken"],
      },
      {
      ...
      },
      {
        ...
        status: "partial",
        details: "Treasury holds 40% (protocol-owned, locked). Excluding protocol wallets, no single holder >10%. Needs more distribution as ecosystem grows.",
        weight: 7,
        requiredBy: ["Coinbase", "Kraken"],
      },
      ...
      },
      {
        ...
        status: "partial",
        details: "Invoice system captures sender/receiver identity. Travel Rule integration planned via Meridian Settlement Engine.",
        weight: 6,
      ...
      // ═══════════════════════════════════════════════════════
      {
        ...
        status: "pass",
        details: "UnyKornLPManager on Avalanche (TraderJoe LB V2.1) — UNY/USDC and UNY/WAVAX pools. Internal AMM for UNY/USDF.",
        weight: 8,
      ...
      },
      {
        ...
        status: "partial",
        details: "Protocol-owned liquidity provides base depth. Deeper order book builds as trading volume increases.",
        weight: 6,
        requiredBy: ["Binance", "Coinbase", "Kraken"],
      },
      ...
      // ═══════════════════════════════════════════════════════
      {
        ...
        status: "pass",
        details: "Avalanche C-Chain (public RPCs + Infura). UnyKorn L1 RPC at rpc.l1.unykorn.org. Polygon (public RPCs).",
        weight: 9,
      ...
      },
      {
        ...
        status: "pass",
        details: "Standard ERC-20 on Avalanche — all EVM-compatible exchanges can integrate with existing infrastructure. Transfer/TransferFrom events for deposit detection.",
        weight: 8,
        requiredBy: ["Binance", "Coinbase", "Kraken", "OKX", "Bybit"],
      },
      {
        ...
        status: "pass",
        details: "Avalanche: ~2s finality (Snowman consensus). UnyKorn L1: ~1s finality (Trinity Consensus). Polygon: ~2s.",
        weight: 8,
        requiredBy: ["Binance", "Coinbase", "Kraken"],
      },
      {
      ...
      // ═══════════════════════════════════════════════════════
      {
        ...
        status: "pass",
        details: "3 active repos (UnyKorn-X402-aws, genesis-world, USDF). 15+ packages, multiple commits daily. Full open-source.",
        weight: 6,
