  ...
  private base(): ApplicationSection[] {
    return [
      ...
      },
      {
        ...
        fields: {
          "Primary Chain": "UnyKorn L1 (7331)",
          "Contract Address": "native (UNY is the native gas + utility token)",
          "Explorer URL": "https://main.unykorn-explorer.pages.dev",
          "Source Verified": "Yes",
          "Audit Status": "OpenZeppelin base (audited). Independent audit in progress.",
          "EVM Compatible": "Yes — standard EVM tooling, wallets, and exchange integration",
          "Consensus": "Trinity Consensus (~1s finality)",
        },
      },
      {
        title: "Tokenomics",
        fields: {
          ...
          "Staking": "Yes — Staking Vault on UnyKorn L1 with real yield from x402 protocol revenue",
        },
      },
      {
        ...
        fields: {
          ...
          "Settlement Speed": "<1 second (UnyKorn L1 Trinity Consensus)",
          ...
          "DEX Liquidity": "UnyKorn L1 native AMM — UNY/USDT and UNY/USDC pools",
          "Internal AMM": "Constant-product AMM pool, 0.3% fee",
      ...
      sections: [
        ...this.base(),
        {
          ...
          fields: {
            ...
            "Custody Compatibility": "Native token on UnyKorn L1 (EVM-compatible) — standard EVM custody integration",
      ...
      sections: [
        ...this.base(),
        {
          ...
          fields: {
            ...
            "On-Chain Data": "Native on UnyKorn L1 (EVM) — automatic supply/holder tracking",
            "DEX Listing": "UnyKorn L1 native AMM — auto-trackable by CoinGecko",
      ...
      sections: [
        ...this.base(),
        {
          ...
          fields: {
            ...
            "Market Pairs": "UNY/USDT, UNY/USDC, UNY/BTC, UNY/ETH",
            "Exchange Listings": "UnyKorn L1 native AMM + protocol-owned liquidity",
      ...
      sections: [
        ...this.base(),
        {
          ...
          fields: {
            ...
            "Integration": "Native on UnyKorn L1 (EVM-compatible) — standard wallet/exchange integration",
          },
        },
      ],
      contacts: this.contacts,
